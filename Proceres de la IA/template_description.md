...
## Estructura de los 5 slides

### 01 · Portada
- Fondo: violeta acento (`#9b5de5`)
- Marco: `rgba(255,255,255,.4)` — blanco semitransparente
- Contenido: pilar + nombre del prócere + bajada de una línea + tags de credenciales
...
- Fondo: lavanda clara
- Marco: violeta acento
- Contenido: "próximo perfil" + CTA + @riesgoia
...
## Lógica narrativa por slide
Cada carrusel de Próceres sigue esta secuencia fija:
1. **Quién es** — impacto visual inmediato con el nombre y una bajada que engancha
2. **Qué hizo** — trayectoria cronológica que establece credibilidad
3. **Qué dijo** — cita directa sobre riesgo que humaniza y persuade
4. **Por qué escucharlo** — el argumento que conecta su expertise con la tesis del canal
5. **Qué sigue** — CTA para continuar la serie
